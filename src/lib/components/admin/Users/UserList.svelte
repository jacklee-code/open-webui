...
> 
> JackAI is completely free to use as-is, with no restrictions or hidden limits, and we'd love to keep it that way. 🌱  
>
...
> 
> - 👉 **[Click here to learn more about JackAI](https://github.com/jacklee-code/open-webui)**
> - 👉 *[Click here to sponsor the project on GitHub](https://github.com/sponsors/jacklee-code)*
`}
			/>
		</div>
	{/if}
